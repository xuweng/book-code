package com.tcpip.sockets.four.three;

import com.tcpip.sockets.three.five.VoteMsg;
import com.tcpip.sockets.three.five.VoteMsgCoder;
import com.tcpip.sockets.three.five.VoteMsgTextCoder;
...
public class VoteMulticastSender {
    ...
    public static void main(String args[]) throws IOException {
        ...
        if (!destAddr.isMulticastAddress()) { // Test if multicast address(是否多播地址)
